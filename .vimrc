...
ab eee exit( __LINE__ . ':' . basename( __FILE__ ) . " ERROR<br />\n" );
...
ab t3ddr t3lib_utility::debugRows( $rows, __LINE__ . ':' . basename( __FILE__ ) );
" ab t3dl t3lib_utility::devLog( true, __FUNCTION__, 0, false );
